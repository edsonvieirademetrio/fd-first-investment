<?php 
    $blogSecao1 = get_field('secao_1', 7);
?>
<main id="primary" class="site-main">
    ...
    <section class="blog-2">
        <div class="container">
            <div class="row py-5">
                <div class="col-12 label-categories-blog">                                    
                    <?php                         
                ...
                <div class="col-12 featured-post-blog mt-4">
                    <?php $the_query = new WP_Query( array( 'posts_per_page' => '2', 'cat' => $blogSecao1['categoria'] ) );  ?>
                ...
                <div class="col-12 list-post-blog mt-4 d-block d-lg-none">
                    <?php $the_query = new WP_Query( array( 'offset' => '-2', 'cat' => $blogSecao1['categoria'] ) );  ?>
                    <?php if ( $the_query->have_posts() ) : ?>
