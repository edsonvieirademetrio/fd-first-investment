...
function get_the_post_navigation( $args = array() ) {
	...
	$previous = get_previous_post_link(
		'<span class="nav-previous ml-0 mx-2">%link</span> | ',
		$args['prev_text'],
		$args['in_same_term'],
		$args['excluded_terms'],
		$args['taxonomy']
	...
	$next = get_next_post_link(
		'<span class="nav-next mx-2">%link</span>',
		$args['next_text'],
		$args['in_same_term'],
		$args['excluded_terms'],
		$args['taxonomy']
...
function get_the_comments_navigation( $args = array() ) {
	...
	if ( get_comment_pages_count() > 1 ) {
		...
		if ( $prev_link ) {
			$navigation .= '<span class="nav-previous">' . $prev_link . '</span>';
		}

		if ( $next_link ) {
			$navigation .= '<span class="nav-next">' . $next_link . '</span>';
		}
